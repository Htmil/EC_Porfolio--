    ...
    return (
        <>
            <div className="mainContent font-bold p-4 sm:p-8 w-full">
                <h1 className="mainTitle text-4xl sm:text-5xl md:text-6xl lg:text-7xl py-2">CURRICULUM VITAE</h1>
                ...
                <div className="cvWrapper font-normal block sm:grid gap-8">
                    <div className="education col-span-2 font-normal">
                        <h2 className="text-2xl sm:text-3xl py-5 font-bold underline" >Education</h2>
                    ...
                    <div className="experience col-span-2 lg:col-span-4">
                        <h2 className="text-2xl sm:text-3xl py-5 font-bold underline">Experience</h2>
                        <div className="infocard">
                            <h3 className="text-xl sm:text-2xl font-semibold" >Malmö University - Teaching Assistant, 2020 - 2022</h3>
                        ...
                        <div className="infocard">
                            <h3 className="text-xl sm:text-2xl pt-5 font-semibold">Kulturskolan in Landskrona - Teacher, 2007 - 2021</h3>
                    ...
                    <div className="contactInfo">
                        <h2 className="text-2xl sm:text-3xl py-5 font-bold underline">Contact information</h2>
                        <a className="text-blue-600 hover:underline" href="mailto:This will show my email">This will show my email.</a>
                        <a className="text-blue-600 hover:underline" href="https://github.com/htmil"><p>Github.com/htmil</p></a>
                    </div>

                    <div className="skills font-normal">
                        <h2 className="text-2xl sm:text-3xl py-5 font-bold underline">Skills</h2>
                    ...
                    <div className="languages font-normal text-1xl">
                        <h2 className="text-2xl sm:text-3xl py-5 font-bold underline">Languages</h2>
                        <p>Swedish / Native</p>
                        <p>English / Fluent</p>
